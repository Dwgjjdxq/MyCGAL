...
public:
    ...
    void setupUi(QDockWidget *Mean_curvature_flow_skeleton_plugin)
    {
        ...
        Mean_curvature_flow_skeleton_plugin->resize(744, 468);
    ...
    {
        Mean_curvature_flow_skeleton_plugin->setWindowTitle(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "DockWidget", 0));
        is_medially_centered->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "Is medially centered", 0));
        label_omega_H->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "quality_speed_tradeoff", 0));
        label_omega_P->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "medially_centered_speed_tradeoff", 0));
        label_min_edge_length->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "min_edge_length", 0));
        label_delta_area->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "area_variation_factor ", 0));
        pushButton_run->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "Run one iteration", 0));
        pushButton_converge->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "Run to convergence", 0));
        pushButton_skeletonize->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "Skeletonize", 0));
        pushButton_segment->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "Segment", 0));
        label->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "Steps of an iteration:", 0));
        pushButton_contract->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", " 1 - Contract", 0));
        pushButton_collapse->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "2 - Collapse", 0));
        pushButton_split->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "3 - Split", 0));
        pushButton_degeneracy->setText(QApplication::translate("Mean_curvature_flow_skeleton_plugin", "4 - Degeneracy", 0));
    } // retranslateUi
