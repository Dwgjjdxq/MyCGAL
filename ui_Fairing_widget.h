...
public:
    ...
    {
        Fairing->setWindowTitle(QApplication::translate("Fairing", "Fairing", 0));
        groupBox->setTitle(QApplication::translate("Fairing", "Fairing", 0));
        label_2->setText(QApplication::translate("Fairing", "Weight Type:", 0));
        Weight_combo_box->clear();
        Weight_combo_box->insertItems(0, QStringList()
         << QApplication::translate("Fairing", "Cotangent Weight", 0)
         << QApplication::translate("Fairing", "Uniform Weight", 0)
        );
        label_3->setText(QApplication::translate("Fairing", "Continuity:", 0));
        Fair_button->setText(QApplication::translate("Fairing", "Fair a region defined by a selection of vertices", 0));
        groupBox_2->setTitle(QApplication::translate("Fairing", "Refining", 0));
        label->setText(QApplication::translate("Fairing", "Density Control Factor:", 0));
        Refine_button->setText(QApplication::translate("Fairing", "Refine a region defined by a selection of faces", 0));
    } // retranslateUi
