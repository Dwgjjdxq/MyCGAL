...
public:
    ...
    void setupUi(QDockWidget *HoleFilling)
    {
        ...
        vertices_threshold_spin_box->setMaximum(1e+09);
        ...
        horizontalLayout_2->addWidget(Create_polyline_items_button);
    ...
    {
        HoleFilling->setWindowTitle(QApplication::translate("HoleFilling", "Hole Filling", 0));
        label_2->setText(QApplication::translate("HoleFilling", "Action:", 0));
        action_combo_box->clear();
        action_combo_box->insertItems(0, QStringList()
         << QApplication::translate("HoleFilling", "Triangulate", 0)
         << QApplication::translate("HoleFilling", "Triangulate + Refine", 0)
         << QApplication::translate("HoleFilling", "Triangulate + Refine + Fair", 0)
        );
        groupBox->setTitle(QApplication::translate("HoleFilling", "Hole Filling Parameters", 0));
        Use_delaunay_triangulation_check_box->setText(QApplication::translate("HoleFilling", "Use 3D Delaunay Triangulation Search Space", 0));
        Skip_self_intersection_check_box->setText(QApplication::translate("HoleFilling", "Skip Hole Fillings Making the Surface Self Intersecting", 0));
        label_4->setText(QApplication::translate("HoleFilling", "Small Hole #Vertices Threshold", 0));
        groupBox_2->setTitle(QApplication::translate("HoleFilling", "Refinement Parameters", 0));
        label->setText(QApplication::translate("HoleFilling", "Density Factor", 0));
        groupBox_3->setTitle(QApplication::translate("HoleFilling", "Fairing Parameters", 0));
        label_5->setText(QApplication::translate("HoleFilling", "Continuity", 0));
        label_3->setText(QApplication::translate("HoleFilling", "Weight Type", 0));
        weight_combo_box->clear();
        weight_combo_box->insertItems(0, QStringList()
         << QApplication::translate("HoleFilling", "Uniform Weight", 0)
         << QApplication::translate("HoleFilling", "Cotangent Weight", 0)
        );
        groupBox_4->setTitle(QApplication::translate("HoleFilling", "Hole Display and Selection", 0));
        Visualize_holes_button->setText(QApplication::translate("HoleFilling", "Detect and Display Holes", 0));
        Select_all_holes_button->setText(QApplication::translate("HoleFilling", "Select All Holes", 0));
        Select_small_holes_button->setText(QApplication::translate("HoleFilling", "Select Small Holes", 0));
        Deselect_all_holes_button->setText(QApplication::translate("HoleFilling", "Deselect All Holes", 0));
        label_6->setText(QApplication::translate("HoleFilling", "Note: Use CTRL+Left mouse click to manually select/deselect a hole", 0));
        groupBox_5->setTitle(QApplication::translate("HoleFilling", "Actions", 0));
        Fill_selected_holes_button->setText(QApplication::translate("HoleFilling", "Fill Selected Holes", 0));
        Create_polyline_items_button->setText(QApplication::translate("HoleFilling", "Create Polyline Items for Selected Holes", 0));
        Reject_button->setText(QApplication::translate("HoleFilling", "Reject", 0));
        Accept_button->setText(QApplication::translate("HoleFilling", "Accept", 0));
    } // retranslateUi
