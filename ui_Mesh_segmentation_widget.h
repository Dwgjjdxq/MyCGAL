...
public:
    ...
    void setupUi(QDockWidget *Mesh_segmentation)
    {
        ...
        Mesh_segmentation->resize(286, 254);
    ...
    {
        Mesh_segmentation->setWindowTitle(QApplication::translate("Mesh_segmentation", "Mesh Segmentation", 0));
        groupBox_2->setTitle(QApplication::translate("Mesh_segmentation", "SDF Calculation Parameters", 0));
        Number_of_rays_label->setText(QApplication::translate("Mesh_segmentation", "Number of rays:", 0));
        Cone_angle_label->setText(QApplication::translate("Mesh_segmentation", "Cone angle:", 0));
        groupBox->setTitle(QApplication::translate("Mesh_segmentation", "Segmentation Parameters", 0));
        Smoothness_label->setText(QApplication::translate("Mesh_segmentation", "Smoothness:", 0));
        Number_of_clusters_label->setText(QApplication::translate("Mesh_segmentation", "Number of clusters:", 0));
        label->setText(QApplication::translate("Mesh_segmentation", "Extract segments:", 0));
        Extract_segments_check_box->setText(QString());
        New_item_label->setText(QApplication::translate("Mesh_segmentation", "Create new item:", 0));
        New_item_check_box->setText(QString());
        SDF_button->setText(QApplication::translate("Mesh_segmentation", "Calculate SDF", 0));
        Partition_button->setText(QApplication::translate("Mesh_segmentation", "Segment", 0));
    } // retranslateUi
