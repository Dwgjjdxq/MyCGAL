...
public:
    ...
    {
        Polyhedron_slicer->setWindowTitle(QApplication::translate("Polyhedron_slicer", "Polyhedron Slicer", 0));
        Base_2_label->setText(QApplication::translate("Polyhedron_slicer", "Base 2", 0));
        Base_1_label->setText(QApplication::translate("Polyhedron_slicer", "Base 1", 0));
        Center_label->setText(QApplication::translate("Polyhedron_slicer", "Center", 0));
        Update_plane_button->setText(QApplication::translate("Polyhedron_slicer", "Update Plane", 0));
        Distance_with_planes_label->setText(QApplication::translate("Polyhedron_slicer", "Distance with planes", 0));
        newPolylineItemCheckBox->setText(QApplication::translate("Polyhedron_slicer", "New polyline item for each polyline", 0));
        Generate_button->setText(QApplication::translate("Polyhedron_slicer", "Generate", 0));
    } // retranslateUi
