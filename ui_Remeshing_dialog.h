...
public:
    ...
    void setupUi(QDialog *Remeshing_dialog)
    {
        ...
        Remeshing_dialog->resize(389, 173);
    ...
    {
        Remeshing_dialog->setWindowTitle(QApplication::translate("Remeshing_dialog", "Meshing criteria", 0));
        angleLabel->setText(QApplication::translate("Remeshing_dialog", "&Angle:", 0));
        sizingLabel->setText(QApplication::translate("Remeshing_dialog", "&Size:", 0));
        approxLabel->setText(QApplication::translate("Remeshing_dialog", "Approximation &error:", 0));
        tags->clear();
        tags->insertItems(0, QStringList()
         << QApplication::translate("Remeshing_dialog", "Non manifold", 0)
         << QApplication::translate("Remeshing_dialog", "Manifold", 0)
         << QApplication::translate("Remeshing_dialog", "Manifold with boundaries", 0)
        );
        label->setText(QApplication::translate("Remeshing_dialog", "&Topological criterion:", 0));
    } // retranslateUi
